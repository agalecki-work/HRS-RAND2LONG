...
program */
libname lib ".";
%let data_map=randhrs1992_2020v1HL_map;

/* populates wave_summary variable */
data lib.&data_map._92; /* postfix _92 added */
 *length wave_pattern $40;
 retain name label format clength dispatch wave_summary wave_pattern;
 set lib.&data_map (drop =id);
 array _waves {*} $ hrs_wave1-hrs_wave15;
 length ci $30; 
 if strip(clength) ="8" then clength ="";  
 countx =0;
